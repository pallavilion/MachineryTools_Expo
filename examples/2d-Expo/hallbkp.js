...
const Postroom = async function (businessID, businessName) {
    try {
        ...
        const response = await fetch(`http://localhost:5098/api/ExpoChat/PostChatRoom`, {
            method: 'POST',
            headers: {
            ...
            <div class="dropdown-menu" id="dropdownid">
              ${(() => {
                ...
                for (let i = 1; i <= stallsData.stalls.length; i++) {
                    dropdownItems += `<a class="dropdown-item" data-index="${i}" onclick="showStall(${i - 1
                        })">Stall ${i}</a>`;
                }
          ...
          <div class="stallContentInner">
            ...
            <div class="agriProducts">
              <div class="agriProductsContents">
                ...
                ? `<a href="${stall.broucherlink}" target="_blank" id="broucher${index + 1
                ...
                'UserName'
                    ...
                    <a href="tel:+91${stall.vendorInfo.contactNumber
