 ...
 --->
	  <div class="welcomeScreen">
        <div class="welcomeScreenContents">
            <div class="chatLogo">
                <img src="./MCCHAT/uiLogo.png">
            </div>
            <div class="welcomeScreenText">
                <p class="chatText">Chats with <span>[Deepika]</span></p>
    ...
    <div class="mblmaxChat">
        <div class="rightChatSection">
            <div class="rightClassContents">
                <p class="chatDetails"><span class="owner">Akshay</span> chats with <span class="customer">Deepika</span></p>
...
document.getElementById("startChatBtn").addEventListener("click", function() {
    ...
    cname = cname.replace(/\s+/g, "_"); // Replaces all spaces with underscores cname
	console.log(name)
  //  cname=name
  console.log(cname)
    if (name) {
