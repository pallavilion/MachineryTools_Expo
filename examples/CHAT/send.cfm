...
<!--- <cfset pusherChannel = "private-1234" /> --->
...
<cfset pusherData = serializeJSON({"message":"#htmlEditFormat(url.message)#",
                   "channel":"#url.channel#",
                    "data":
                         '{
                         "message":"#htmlEditFormat(url.message)#",
                         "userID":"#htmlEditFormat(url.handle)#"
                         }',
                  "userID":"#url.userID#",
...
<cfset inputString = "POST\n/apps/#pusherAppID#/events\nauth_key=#pusherKey#&auth_timestamp=#authTimeStamp#&auth_version=1.0&body_md5=#authMD5Body#&name=Test" />
...
--->
<cfhttp result="resp" method="post" url="https://api-ap2.pusher.com#pusherResource#">
    ...
    <cfhttpparam type="body" value="#pusherData#" />
</cfhttp>
